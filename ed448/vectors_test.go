...
// Known answers from RFC 8032 §7.4 (Ed448) and §7.5 (Ed448ph). These are
// the scheme's own published vectors, so they check this package against
...
var rfc8032Ed448 = []vector{
	{
		name: "Blank",
		seckey: "6c82a562cb808d10d632be89c8513ebf6c929f34ddfa8c9f63c9960ef6e348a3" +
			"528c8a3fcc2f044e39a3fc5b94492f8f032e7549a20098f95b",
		pubkey: "5fd7449b59b461fd2ce787ec616ad46a1da1342485a70e1f8a0ea75d80e96778" +
	...
	{
		name: "1 octet",
		seckey: "c4eab05d357007c632f3dbb48489924d552b08fe0c353a0d4a1f00acda2c463a" +
			"fbea67c5e8d2877c5e3bc397a659949ef8021e954e0a12274e",
		pubkey: "43ba28f430cdff456ae531545f7ecd0ac834a55d9358c0372bfa0c6c6798c086" +
	...
	{
		name: "11 octets",
		seckey: "cd23d24f714274e744343237b93290f511f6425f98e64459ff203e8985083ffd" +
			"f60500553abc0e05cd02184bdb89c4ccd67e187951267eb328",
		pubkey: "dcea9e78f35a1bf3499a831b10b86c90aac01cd84b67a0109b55a36e9328b1e3" +
	...
	{
		name: "12 octets",
		seckey: "258cdd4ada32ed9c9ff54e63756ae582fb8fab2ac721f2c8e676a72768513d93" +
			"9f63dddb55609133f29adf86ec9929dccb52c1c5fd2ff7e21b",
		pubkey: "3ba16da0c6f2cc1f30187740756f5e798d6bc5fc015d7c63cc9510ee3fd44adc" +
			"24d8e968b6e46e6f94d19b945361726bd75e149ef09817f580",
		msg: "64a65f3cdedcdd66811e2915",
		ctx: "",
		sig: "7eeeab7c4e50fb799b418ee5e3197ff6bf15d43a14c34389b59dd1a7b1b85b4a" +
	...
	{
		name: "13 octets",
		seckey: "7ef4e84544236752fbb56b8f31a23a10e42814f5f55ca037cdcc11c64c9a3b29" +
			"49c1bb60700314611732a6c2fea98eebc0266a11a93970100e",
		pubkey: "b3da079b0aa493a5772029f0467baebee5a8112d9d3a22532361da294f7bb381" +
			"5c5dc59e176b4d9f381ca0938e13c6c07b174be65dfa578e80",
		msg: "64a65f3cdedcdd66811e2915e7",
		ctx: "",
		sig: "6a12066f55331b6c22acd5d5bfc5d71228fbda80ae8dec26bdd306743c5027cb" +
	...
	{
		name: "64 octets",
		seckey: "d65df341ad13e008567688baedda8e9dcdc17dc024974ea5b4227b6530e339bf" +
			"f21f99e68ca6968f3cca6dfe0fb9f4fab4fa135d5542ea3f01",
		pubkey: "df9705f58edbab802c7f8363cfe5560ab1c6132c20a9f1dd163483a26f8ac53a" +
			"39d6808bf4a1dfbd261b099bb03b3fb50906cb28bd8a081f00",
		msg: "bd0f6a3747cd561bdddf4640a332461a4a30a12a434cd0bf40d766d9c6d458e5" +
			"512204a30c17d1f50b5079631f64eb3112182da3005835461113718d1a5ef944",
		ctx: "",
		sig: "554bc2480860b49eab8532d2a533b7d578ef473eeb58c98bb2d0e1ce488a98b1" +
	...
	{
		name: "256 octets",
		seckey: "2ec5fe3c17045abdb136a5e6a913e32ab75ae68b53d2fc149b77e504132d3756" +
			"9b7e766ba74a19bd6162343a21c8590aa9cebca9014c636df5",
		pubkey: "79756f014dcfe2079f5dd9e718be4171e2ef2486a08f25186f6bff43a9936b9b" +
			"fe12402b08ae65798a3d81e22e9ec80e7690862ef3d4ed3a00",
		msg: "15777532b0bdd0d1389f636c5f6b9ba734c90af572877e2d272dd078aa1e567c" +
		...
		ctx: "",
		sig: "c650ddbb0601c19ca11439e1640dd931f43c518ea5bea70d3dcde5f4191fe53f" +
	...
	{
		name: "1023 octets",
		seckey: "872d093780f5d3730df7c212664b37b8a0f24f56810daa8382cd4fa3f77634ec" +
			"44dc54f1c2ed9bea86fafb7632d8be199ea165f5ad55dd9ce8",
		pubkey: "a81b2e8a70a5ac94ffdbcc9badfc3feb0801f258578bb114ad44ece1ec0e799d" +
			"a08effb81c5d685c0c56f64eecaef8cdf11cc38737838cf400",
		msg: "6ddf802e1aae4986935f7f981ba3f0351d6273c0a0c22c9c0e8339168e675412" +
		...
		ctx: "",
		sig: "e301345a41a39a4d72fff8df69c98075a0cc082b802fc9b2b6bc503f926b65bd" +
...
var rfc8032Ed448ph = []vector{
	{
		name: "TEST abc",
		seckey: "833fe62409237b9d62ec77587520911e9a759cec1d19755b7da901b96dca3d42" +
			"ef7822e0d5104127dc05d6dbefde69e3ab2cec7c867c6e2c49",
		pubkey: "259b71c19f83ef77a7abd26524cbdb3161b590a48f7d17de3ee0ba9c52beb743" +
...
func TestRFC8032Ed448(t *testing.T) {
	for _, v := range rfc8032Ed448 {
		t.Run(v.name, func(t *testing.T) {
			k, err := PrivateKeyFromBytes(mustHex(t, v.seckey))
			require.NoError(t, err)

			pub := k.PublicKey().Bytes()
			assert.Equal(t, mustHex(t, v.pubkey), pub[:], "public key")

			msg, ctx := mustHex(t, v.msg), mustHex(t, v.ctx)
			sig, err := Sign(k, msg, ctx)
			require.NoError(t, err)

			got := sig.Bytes()
			assert.Equal(t, mustHex(t, v.sig), got[:], "signature")
			assert.True(t, Verify(k.PublicKey(), msg, ctx, sig))
		})
	}
}

// Ed448ph takes the raw message here: CIRCL applies SHAKE-256 itself
// rather than taking a caller-supplied digest.
func TestRFC8032Ed448ph(t *testing.T) {
	for _, v := range rfc8032Ed448ph {
		t.Run(v.name, func(t *testing.T) {
			k, err := PrivateKeyFromBytes(mustHex(t, v.seckey))
			require.NoError(t, err)
			...
			msg, ctx := mustHex(t, v.msg), mustHex(t, v.ctx)
			sig, err := SignPh(k, msg, ctx)
			require.NoError(t, err)

			got := sig.Bytes()
			assert.Equal(t, mustHex(t, v.sig), got[:], "signature")
			assert.True(t, VerifyPh(k.PublicKey(), msg, ctx, sig))
		})
	}
}
