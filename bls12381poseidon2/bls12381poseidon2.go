...
//
// Like bls12381mimc and unlike every other hash in this module, Poseidon2 is
...
//
// Unlike bls12381mimc, where compressing two elements is just hashing two
...
//
// Unlike bls12381mimc's, this Sum is a pure read: it does not advance the
