...
var (
	...
	ErrInvalidPrivateKey = errors.New("bls12377: invalid private key")
	...
	ErrPairingFailed = errors.New("bls12377: pairing operation failed")
	...
	// different lengths.
	ErrLengthMismatch = errors.New("bls12377: mismatched input lengths")
	...
	// not supplied.
	ErrSigningFailed = errors.New("bls12377: signing failed")
	...
	ErrHashRequired = errors.New("bls12377: a hash function is required")
)
