...
import (
	...
	gnarkecdsa "github.com/consensys/gnark-crypto/ecc/bls12-377/ecdsa"
)

// ECDSA over BLS12-377's own group, as gnark-crypto implements it: SEC 1
...
const (
	...
	ECDSAPubkeyLen = G1CompressedLen
)

// ECDSAPrivateKey is a BLS12-377 scalar used for ECDSA.
