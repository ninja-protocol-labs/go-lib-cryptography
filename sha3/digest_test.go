...
func TestDigest(t *testing.T) {
	t.Run("SHA3-224", func(t *testing.T) { checkDigest224(t, testMsg, abcSHA3_224) })
	t.Run("SHA3-256", func(t *testing.T) { checkDigest256(t, testMsg, abcSHA3_256) })
	t.Run("SHA3-384", func(t *testing.T) { checkDigest384(t, testMsg, abcSHA3_384) })
	t.Run("SHA3-512", func(t *testing.T) { checkDigest512(t, testMsg, abcSHA3_512) })
}
