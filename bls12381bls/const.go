// Package bls12381bls implements BLS signatures — Boneh-Lynn-Shacham — on
// the BLS12-381 curve. The two BLSes are unrelated: the curve is named for
...
//
// The curve arithmetic these signatures are built on lives in bls12381.
package bls12381bls
