// Package poseidon2bn254 is the public API for Poseidon2 over BLS12-377's
// scalar field.
//
...
//
// Like mimcbls12377 and unlike every other hash in this module, Poseidon2 is
...
//
// Unlike mimcbls12377, where compressing two elements is just hashing two
...
// # Which parameters
//
// The permutation is width 2, with 6 full rounds and 26 partial rounds:
...
// Element is one BLS12-377 scalar-field element, big-endian, and canonical:
...
//
// Unlike mimcbls12377's, this Sum is a pure read: it does not advance the
